// create a variable to hold project info (name, descriptions, photo path, tech stack)
const ProjectInfo = {
    projects: [
        {
            ...
            'tech_stack': 'Node.JS • Express • PostgreSQL • CSS • Bootstrap',
            'link': 'https://heavy-things-tracker.herokuapp.com/',
            'date': 'November 2021',
